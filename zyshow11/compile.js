/**
 * 把 zyshow11.js 编译成海阔视界 v2 规则 + 各类口令
 */
const fs = require('fs');
const path = require('path');

const ruleFile = path.join(__dirname, 'zyshow11.js');
...
(function () {
    ...
    const v2 = {
        ...
        titleColor: '',
        url: rule.url || '',
        col_type: rule.col_type || 'movie_1',
    ...
    const miniRule = Object.assign({}, v2, {
        title: '11\u70b9\u70ed\u7092\u5e97', author: 'claude', version: 0, icon: '', proxy: ''
    });
